...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *FirstAWSServerlessApp*):

Restore dependencies
```
    cd "FirstAWSServerlessApp"
    dotnet restore
```

Execute unit tests
```
    cd "FirstAWSServerlessApp/test/FirstAWSServerlessApp.Tests"
    dotnet test
```

Deploy application
```
    cd "FirstAWSServerlessApp/src/FirstAWSServerlessApp"
